                ...
                <div class="card card-flush h-lg-100" id="kt_contacts_main"
                    ...
                    <div style="margin-bottom: 30px" class="card-header pt-7" id="kt_chat_contacts_header">
                        ...
                        <div class="card-title">
                            ...
                            <!--end::Svg Icon-->
                            <h2 style="margin-right: 5px">عرض الصلاحيات</h2>
                        </div>
                        <div class="d-flex justify-content-end mt-7">
                            <!--begin::Button-->
                            <a style="font-size: 18px" href="{{route('roles.create')}}"
                            ...
                            <table class="table table-hover table-rounded table-striped border gy-5 gs-5">
                                <thead>
                                    <tr class="fw-semibold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                                        <th style="font-size: 20px;width: 20%">اسم الصلاحية</th>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <span style="font-size: 16px"
                                                        class="badge badge-light-primary fw-bold">{{$abilitie}}</span>
                                                </li>
@endforeach
                                            </ul>
                                        </td>
                                        <td>
                                            <a href="{{route('roles.edit',$role->id)}}"
                                                class="btn btn-icon btn-success"><span class="svg-icon svg-icon-1">
                                            ...
                                            <form action="{{route('roles.destroy',$role->id)}}" method="post">
                                                @csrf
                                                @method('delete') 
                                                <button type="submit" class="btn btn-icon btn-danger" > <span
