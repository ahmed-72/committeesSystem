        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-lg-row-fluid">
                ...
                <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                    ...
                    <!--end::Image-->
                    <!--begin::Title-->
                    <h1 class="text-gray-800 fs-2qx fw-bold text-center mb-7">welcome</h1>
                    <!--end::Title-->
                    <!--begin::Text-->
                    <!--end::Text-->
                </div>
                ...
                <div class="bg-body d-flex flex-center rounded-4 w-md-600px p-10">
                    ...
                    <div class="w-md-400px">
                        ...
                        <form method="POST" action="{{ route('registerStore') }}">
                            <!-- <form class="form w-100" id="kt_sign_up_form" method="POST" action="{{route('registerStore')}}">
	    -->
                            @csrf
                            <!--begin::Heading-->
                            ...
                            <!--begin::Heading-->
                            <x-auth-validation-errors class="mb-2 alert alert-danger" :errors="$errors" />
                            ...
                            <div class="fv-row mb-8" data-kt-password-meter="true">
                                ...
                                <!--end::Wrapper-->
                                <!--begin::Hint-->
                                <div class="text-muted">Use 8 or more characters you can use letters,numbers &amp;symbols</div>
                                <!--end::Hint-->
                            </div>
                            <!--end::Input group=-->
                            <!--end::Input group=-->
